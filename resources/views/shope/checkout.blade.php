        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.blade.php"><img src="images/logo.png" class="logo" alt=""></a>
                </div>
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="shop.blade.php">Jackets</a></li>
                                                    <li><a href="shop.blade.php">Shirts</a></li>
                                                    <li><a href="shop.blade.php">Sweaters & Cardigans</a></li>
                                                    <li><a href="shop.blade.php">T-shirts</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- end col-3 -->
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="shop.blade.php">Swimwear</a></li>
                                                    <li><a href="shop.blade.php">Skirts</a></li>
                                                    <li><a href="shop.blade.php">Jeans</a></li>
                                                    <li><a href="shop.blade.php">Trousers</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- end col-3 -->
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="shop.blade.php">Top Wear</a></li>
                                                    <li><a href="shop.blade.php">Party wear</a></li>
                                                    <li><a href="shop.blade.php">Bottom Wear</a></li>
                                                    <li><a href="shop.blade.php">Indian Wear</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="shop.blade.php">Bags</a></li>
                                                    <li><a href="shop.blade.php">Sunglasses</a></li>
                                                    <li><a href="shop.blade.php">Fragrances</a></li>
                                                    <li><a href="shop.blade.php">Wallets</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- end col-3 -->
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="shop-detail.blade.php">Shop Detail</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="service.blade.php">Our Service</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="row">
                        ...
                        <div class="col-12 d-flex shopping-box"> <a href="checkout.blade.php" class="ml-auto btn hvr-hover">Place Order</a> </div>
                    </div>
                </div>
            </div>
