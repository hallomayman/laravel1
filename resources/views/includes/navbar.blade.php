    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="indexbalde.php"><img src="images/logo.png" class="logo" alt=""></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    <li class="nav-item"><a class="nav-link" href="indexbalde.php">Home</a></li>
                    <li class="nav-item active"><a class="nav-link" href="about.balde.php">About Us</a></li>
